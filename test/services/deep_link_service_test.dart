...
void main() {
  group('Deep link URI parsing', () {
    test('valid deep link is parsed into a LocationShortcut', () {
      final uri = Uri.parse(
        'navigo://add?label=Hospital&lat=28.5&lng=77.1&placeId=abc&address=Test+Addr&icon=hospital',
      );
    ...
    test('invalid lat/lng default to 0.0', () {
      final uri = Uri.parse(
        'navigo://add?label=Bad&lat=notanumber&lng=alsonotanumber',
      );
    ...
    test('missing label defaults to Unknown Place', () {
      final uri = Uri.parse('navigo://add?lat=10&lng=20');
